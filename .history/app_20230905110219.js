...
// convert/combine all the data in a var to then append them to the IDs in the html
function show(data) {
  var rate_eur = data.bpi.EUR.symbol + data.bpi.EUR.rate;
  var rate_usd = data.bpi.USD.symbol + data.bpi.USD.rate;
